...
<!-- 현재 J쿼리코어파일이 footer.jsp에 있기때문에 아래J쿼리실행은 코어 아래쪽에 있어야함 -->
<!-- 이렇게 상단부터 프로그램 내용을 해석=컴파일하는 과정을 인터프리터형 프로그램언어임.  -->
<script>
jQuery(document).ready(function(){
	jQuery("#board_type").bind("blur",function(){
		if(jQuery(this).val() != "") {
			...
			board_type_list = board_type_list.replace(/\]/g,"");//특수문자 \] 제거
			board_type_list = board_type_list.replace(/\s/g,"");//특수문자 \s 공백제거
