...
<!-- 스프링에서는 액션으로 폼데이터를 전송할 위치를 지정할때, contact.html직접X /contact처럼 컨트롤러를 통해O -->
...
<!-- 입력제약조건 html5에서 지원하는 기능 type에 꼭 email라고 형식을 지정해야만 제약조건이 작동. -->
</div>
...
<!-- form 태그의 목적은 input,textarea,checkbox,radio,select 데이터를 submit(전송)하는것이 목적. -->
